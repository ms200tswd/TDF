    ...
    let steps = [
        {
            ...
            description:
                "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nesciunt, amet quae blanditiis eum, commodi nam rem provident pariatur ducimus reiciendis cupiditate, placeat non? Minima nihil debitis mollitia ipsum accusamus magni.",
        },
        {
            name: "Demo Todos",
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Leo</span> Liu
                <br />Junior
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    Demo Store created with <strong
            ...
            <Step step={steps[1]}>
                <p>
                    Demo Todos is a Full Stack <strong
            ...
            <Step step={steps[2]}>
                <p>
                    Demo Pokemon is a <strong class="text-violet-400"
